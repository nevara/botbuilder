    ...
    <header>
      <nav>
        <ul>
          ...
          <li class="nav-item">
            <router-link class="nav-link" :to="{name: 'Build'}" exact>Build-a-Bot</router-link>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item cart">
            ...
            <div class="cart-items" v-if="cart.length > 0">{{cart.length}}</div>
          </li>
        </ul>
      </nav>
    </header>
